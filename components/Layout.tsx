      ...
      <footer className="bg-brand-dark text-white pt-16 pb-8 border-t-4 border-brand-red">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><Link to="/dump-trailers-cypress" className="hover:text-brand-red transition-colors">Dump Trailers</Link></li>
              <li><Link to="/utility-trailers-cypress" className="hover:text-brand-red transition-colors">Utility Trailers</Link></li>
              <li><Link to="/inventory?cat=Equipment" className="hover:text-brand-red transition-colors">Equipment Haulers</Link></li>
              <li><Link to="/gooseneck-trailers-cypress" className="hover:text-brand-red transition-colors">Gooseneck Flatbeds</Link></li>
            </ul>
          </div>
